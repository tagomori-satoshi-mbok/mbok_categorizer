...
- CORS はデフォルトで `http://localhost:3000`、`http://127.0.0.1:3000`、`https://mbok-gemini-frontend-qyhd7jx6ca-an.a.run.app` を許可しています。必要に応じて環境変数 `CORS_ALLOW_ORIGINS` にカンマ区切りでオリジンを指定してください（`*` で全許可）。
